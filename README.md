# 👨🏻‍💻 Hong Changi
> **Software Engineer & Indie Developer | Solving Problems with Code**
> 사용자 경험을 개선하고 일상의 불편함을 해소하는 서비스를 빠르게 기획·출시하며, 현재는 독립적으로 다양한 MVP 프로덕트를 빌딩하고 서비스를 운영 중인 1인 개발자입니다. AI를 적극 활용하여 기획부터 배포까지의 사이클을 극대화하고 있습니다.
...
- **Java / Spring Boot**: 비즈니스 로직 설계 및 엔터프라이즈 솔루션 개발
...
- **Tech Stack**: React (Vite), Firebase, Vanilla CSS, Framer Motion, i18next, JavaScript
...
- **STEG (에스티이지)** | 2024.02 - 2026.06
  - ITSM 솔루션 커스터마이징 및 기능 고도화 개발
